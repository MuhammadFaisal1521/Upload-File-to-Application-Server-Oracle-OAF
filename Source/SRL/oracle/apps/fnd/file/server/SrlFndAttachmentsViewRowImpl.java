...
public class SrlFndAttachmentsViewRowImpl extends OAViewRowImpl {
    ...
    public static final int LASTUPDATEDBY = 4;
    public static final int LASTUPDATELOGIN = 5;
    public static final int LASTUPDATEDATE = 6;
    public static final int FORMNAME = 7;
    public static final int CONTENTTYPE = 8;
    public static final int ATTACHMENTSID = 9;
    public static final int SUBGROUPNAME = 10;
    ...
    /**Gets the attribute value for the calculated attribute Subgroupname
     */
    public String getSubgroupname() {
        return (String) getAttributeInternal(SUBGROUPNAME);
    }

    /**Sets <code>value</code> as the attribute value for the calculated attribute Subgroupname
     */
    public void setSubgroupname(String value) {
        setAttributeInternal(SUBGROUPNAME, value);
    }
}
